...
/// where
///     T: GetPubFieldOffset<TS!(a), Field = u8, Alignment = A>,
///     T: GetPubFieldOffset<TS!(b), Field = u8, Alignment = A>,
///     T: GetPubFieldOffset<TS!(c), Field = u8, Alignment = A>,
///     T: GetPubFieldOffset<TS!(d), Field = u8, Alignment = A>,
///     T: ROExtOps<A>,
/// {
